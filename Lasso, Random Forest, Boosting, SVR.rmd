...
Create a $4 \times 2$ figures with rows corresponding to each of the four methods and each column to train and test data, and each pannel should be a plot $y$ versus $\hat y$. The objective is to see how these methods are qualitatively different.
```{r}
